...
public class TeacherController {
    ...
    public ResponseEntity<Map<String, Object>> searchTeachersByName(@RequestParam String name) {
    ...
    @Operation(summary = "按院系搜索教师")
    public ResponseEntity<Map<String, Object>> searchTeachersByDepartment(@RequestParam String department) {
        List<Teacher> teachers = teacherService.searchTeachersByDepartment(department);
        Map<String, Object> response = new HashMap<>();
        response.put("code", 200);
        response.put("message", "搜索成功");
        response.put("data", teachers);
